local Library = {}; do
    Library = {
        Accent = Color3.fromRGB(113, 80, 240);
        Inline = Color3.fromRGB(24, 24, 36); 
        Background = Color3.fromRGB(32, 32, 48);
    ...
    do
        ...
        if not isfile(Library.FolderName .. '/Utilities/Hue.png') then
            writefile(Library.FolderName .. '/Utilities/Hue.png', game:HttpGet("https://raw.githubusercontent.com/Sphereuz/celestialuilibarchive/refs/heads/main/hue.png"));
        end;

        if not isfile(Library.FolderName .. '/Utilities/Saturation.png') then
            writefile(Library.FolderName .. '/Utilities/Saturation.png', game:HttpGet("https://raw.githubusercontent.com/Sphereuz/celestialuilibarchive/refs/heads/main/saturation.png"));
        end;

        if not isfile(Library.FolderName .. '/Utilities/Value.png') then
            writefile(Library.FolderName .. '/Utilities/Value.png', game:HttpGet("https://raw.githubusercontent.com/Sphereuz/celestialuilibarchive/refs/heads/main/value.png"));
        end;

        if not isfile(Library.FolderName .. '/Utilities/Shadow.png') then
            writefile(Library.FolderName .. '/Utilities/Shadow.png', game:HttpGet("https://raw.githubusercontent.com/Sphereuz/celestialuilibarchive/refs/heads/main/shadow.png"));
        end;

        if not isfile(Library.FolderName .. '/Utilities/Logo.png') then
            writefile(Library.FolderName .. '/Utilities/Logo.png', game:HttpGet("https://raw.githubusercontent.com/Sphereuz/celestialuilibarchive/refs/heads/main/celestiallogo-removebg-preview.png"));
        end;
    end;
    ...
    do
        ...
        fonts = {
            ["windows-xp-tahoma"] = {
                ...
                url = "https://github.com/Sphereuz/celestialuilibarchive/raw/refs/heads/main/windows-xp-tahoma.ttf"
            };

            ["proggy-square"] = {
                file_name = {"proggySquare.ttf", "proggySquare.json"},
                url = "https://github.com/Sphereuz/celestialuilibarchive/raw/refs/heads/main/proggy-square.ttf"
            };

            ["proggy-clean"] = {
                file_name = {"proggyClean.ttf", "proggySquare.json"},
                url = "https://github.com/Sphereuz/celestialuilibarchive/raw/refs/heads/main/proggy-clean.ttf"
            };

            ["proggy-tiny"] = {
                file_name = {"proggyTiny.ttf", "proggyTiny.json"},
                url = "https://github.com/Sphereuz/celestialuilibarchive/raw/refs/heads/main/proggy-tiny.ttf"
            };

            ["minecraftia"] = {
                file_name = {"minecraftia.ttf", "minecraftia.json"},
                url = "https://github.com/Sphereuz/celestialuilibarchive/raw/refs/heads/main/minecraftia.ttf"
            };
        };
    ...
    function Library:Watermark(Data)
        ...
        Objects["shadow"].Image = "rbxassetid://1316045217" 
    ...
    function Library.Tabs:Section(Data)
        ...
        Objects["text"].Size = UDim2.new(0, Objects["text"].TextBounds.X + 14, 0, 15);
