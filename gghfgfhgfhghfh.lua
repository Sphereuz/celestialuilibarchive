local Library = {}; do
    ...
    do
        ...
        if not isfile(Library.FolderName .. '/Utilities/Logo.png') then
            writefile(Library.FolderName .. '/Utilities/Logo.png', game:HttpGet("https://raw.githubusercontent.com/Sphereuz/celestialuilibarchive/refs/heads/main/noFilter.png"));
        end;
    end;
